  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Sobre la Cliníca Sol Oeste" />
      ...
      <section className="section-about conteiner">
      ...
      <section className="wrapper-carrusel conteiner ">
        <Slider {...settings}>
          <div
            onClick={changeInfo.doctor1}
            className="box-carrusel doctor-about-1"
          >
            <br />
            <p>Dr. Oscar Soto</p>
          </div>
          <div
            onClick={changeInfo.doctor2}
            className="box-carrusel doctor-about-2"
          >
            <br />
            <p>Dra. Ericka Madrigal Soto</p>
          </div>
          <div
            onClick={changeInfo.doctor3}
            className="box-carrusel doctor-about-3"
          >
            <br />
            <p>Dr. Victor Sanchez </p>
          </div>
          <div
            onClick={changeInfo.doctor4}
            className="box-carrusel doctor-about-4"
          >
            <br />
            <p>Dr. Andres Fernandez</p>
          </div>
          <div
            onClick={changeInfo.doctor5}
            className="box-carrusel doctor-about-5"
          >
            <br />
            <p>Dr. Alejandro Mora </p>
          </div>
          <div
            onClick={changeInfo.doctor6}
            className="box-carrusel doctor-about-6"
          >
            <br />
